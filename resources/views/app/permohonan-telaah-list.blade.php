<x-layouts.app title="Telaah Permohonan">
    <div class="flex flex-col gap-6 w-full">
        ...
        <div class="bg-base-100 rounded-box">
            <div class="border-b p-4 text-lg">Permohonan Perlu Ditelaah</div>
                ...
                <div class="overflow-auto">
                    <table class="table">
                        ...
                        @foreach($data as $row)
                            <tr>
                                <td>
                                    <a wire:navigate href="{{route('app.permohonan.telaah', ['permohonan'=>$row])}}"
                                       class="btn btn-sm btn-outline btn-primary normal-case">Telaah</a>
                                </td>
            ...
            @else
                <div class="p-3">Belum ada permohonan untuk ditelaah</div>
            @endif
        </div>
